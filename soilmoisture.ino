...
String apiKey = "HGUFU57GCLTMQUDO"; // Enter your Write API key from ThingSpeak
const char *ssid = "GalaxyF23 5G";     // replace with your wifi ssid and wpa2 key
const char *pass = "oill7821";
