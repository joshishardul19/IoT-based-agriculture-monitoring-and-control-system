...
if __name__ == '__main__':
    ...
    if message_string:
        ...
        while (publish_count <= message_count) or (message_count == 0):
            ...
            message = ("{} {} {} {} {} {} {} {}".format(message0, message1, sensor_id, message2, temperature_c, message3, humidity, message4))
            #message = ("{Temperature = {}, Humidity = {}}".format(temperature_c, humidity))
            #message = ("Temperature = {:.1f}C Humidity = {:.1f}%".format(temperature_c, humidity))
            print("Publishing message to topic '{}': {}".format(message_topic, message))
            message_json_dump = json.dumps(message)
            message_json = json.loads(message_json_dump)
